...
var featuredcontentslider = {
    settingcaches: {}, init: function (a) {
        ...
        var f = a.currentpage, j = a.contentdivs, i = j.length,
        ...
        a.prevpage = d;
        if (a.toc == "scroll") {
            var c = this, h = 0.25, m = 20, k = c.masker.clientWidth, n = a.contentdivs.length, o = a.toclinks[d - 1],
                l = this.thumbWidth[this.thumbWidth.length - 1], d = k / 2 - o.offsetWidth / 2 - this.thumbWidth[d - 1],
        ...
        if (e == "check") return f.test(a.className); else if (e == "remove") a.className = a.className.replace(f, ""); else if (e == "add") a.className += " " + b
